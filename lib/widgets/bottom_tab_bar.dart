...
enum BottomTabBarType {
  /// The [BottomTabBar]'s [BottomTabBarItem]s have fixed width.
  fixed,

  /// The location and size of the [BottomNavigationBar] [BottomTabBarItem]s
...
/// [BottomTabBarType.fixed] when there are less than four items, and
/// [BottomTabBarType.shifting] otherwise.
///
...
class BottomTabBar extends StatefulWidget {
  ...
  /// [BottomTabBarType.fixed] and `false` if [type] is
  ...
  /// The z-coordinate of this [BottomTabBar].
  ///
  ...
  /// Defines the layout and behavior of a [BottomTabBar].
  ///
  /// See documentation for [BottomTabBarType] for information on the
  ...
  /// The color of the [BottomTabBar] itself.
  ///
  /// If [type] is [BottomTabBarType.shifting] and the
  /// [items]s, have [BottomTabBarItem.backgroundColor] set, the [item]'s
  ...
  /// The color of the selected [BottomTabBarItem.icon] and
  /// [BottomTabBarItem.label].
  ///
  /// If null then the [ThemeData.primaryColor] is used.
  final Color selectedItemColor;

  /// The color of the unselected [BottomTabBarItem.icon] and
  /// [BottomTabBarItem.label]s.
  ///
  /// If null then the [TextTheme.caption]'s color is used.
  final Color unselectedItemColor;

  /// The size, opacity, and color of the icon in the currently selected
  /// [BottomTabBarItem.icon].
  ///
  ...
  /// The [TextStyle] of the [BottomTabBarItem] labels when they are
  /// selected.
  final TextStyle selectedLabelStyle;

  /// The [TextStyle] of the [BottomTabBarItem] labels when they are not
  /// selected.
  final TextStyle unselectedLabelStyle;

  /// The font size of the [BottomTabBarItem] labels when they are selected.
  ///
  ...
  /// The font size of the [BottomTabBarItem] labels when they are not
  /// selected.
  ///
  ...
  /// Whether the labels are shown for the selected [BottomTabBarItem].
  final bool showUnselectedLabels;

  /// Whether the labels are shown for the unselected [BottomTabBarItem]s.
  ...
  static bool _defaultShowUnselected(BottomTabBarType type) {
    switch (type) {
...
class _BottomTabBarTile extends StatelessWidget {
  const _BottomTabBarTile(
    this.type,
    this.item,
    this.animation,
    this.iconSize, {
  ...
  Widget _buildBadge() {
    if (item.badgeWidget == null &&
        (item.badgeNo == null || item.badgeNo <= 0)) {
      return Container();
    }
    if (item.badgeWidget != null) {
      return item.badgeWidget;
    }

    var badgeCount = item.badgeNo >= 100 ? '99+' : '${item.badgeNo}';
    return Container(
      width: 24,
  ...
  List<Widget> _createTiles() {
    ...
    for (int i = 0; i < widget.items.length; i++) {
      tiles.add(_BottomTabBarTile(
        ...
        badgeColor:
            widget.badgeColor == null ? widget.fixedColor : widget.badgeColor,
      ));
    }
    return tiles;
  }
